...
class PID(object):
    ...
    def update(self, cur_val, output=None, mode=''):
...
try:
    ...
    while True:
        ...
        # 3 PID
        AMP_PID = PID(targetValue, delta_t, 0.03, 0.0075, 0.04)
        FREQ_PID = PID(targetValue, delta_t, 0.08, 0.00725, 0)
