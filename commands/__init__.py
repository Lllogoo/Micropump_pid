...
from commands.connection.shdlc_functions import SHDLC_SerialConnection
from commands.sf04_commands import get_measurement_sf04, set_resolution_sf04, toggle_heater_sf04
from commands.sf06_commands import get_measurement_sf06, reset_cable_sf06, set_sensor_sf06
...
def init_flowmeter(board, chip='SF06', debug=False):
...
# -------------------
# Close the flowmeter
def close_flowmeter(board, chip='SF06', debug=False):
